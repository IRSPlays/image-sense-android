...
export const fishData: Fish[] = [
  // Protected species
  { id: 1, name: 'Basking Shark', scientificName: 'Cetorhinus maximus', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b', habitat: 'Marine', size: 'Very large', status: 'protected', 
  ...
  { id: 2, name: 'Devil Rays', scientificName: 'Mobula species', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1518770660439-4636190af475', habitat: 'Marine', size: 'Large', status: 'protected',
  ...
  { id: 3, name: 'Giant Guitarfishes', scientificName: 'Glaucostegus spp.', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e', habitat: 'Marine', size: 'Large', status: 'protected',
  ...
  { id: 4, name: 'Great White Shark', scientificName: 'Carcharodon carcharias', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1531297484001-80022131f5a1', habitat: 'Marine', size: 'Very large', status: 'protected',
  ...
  { id: 5, name: 'Great Hammerhead Shark', scientificName: 'Sphyrna mokarran', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7', habitat: 'Marine', size: 'Large', status: 'protected',
  ...
  { id: 6, name: 'Whale Shark', scientificName: 'Rhincodon typus', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1518770660439-4636190af475', habitat: 'Marine', size: 'Very large', status: 'protected',
  ...
  { id: 7, name: 'Smooth Hammerhead Shark', scientificName: 'Sphyrna zygaena', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b', habitat: 'Marine', size: 'Large', status: 'protected',
  ...
  { id: 8, name: 'Scalloped Hammerhead Shark', scientificName: 'Sphyrna lewini', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e', habitat: 'Marine', size: 'Large', status: 'protected',
  ...
  { id: 9, name: 'Shortfin Mako Shark', scientificName: 'Isurus oxyrinchus', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1531297484001-80022131f5a1', habitat: 'Marine', size: 'Large', status: 'protected',
  ...
  { id: 10, name: 'Longfin Mako Shark', scientificName: 'Isurus paucus', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7', habitat: 'Marine', size: 'Large', status: 'protected',
  ...
  { id: 11, name: 'Manta Rays', scientificName: 'Manta spp.', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1518770660439-4636190af475', habitat: 'Marine', size: 'Very large', status: 'protected',
  ...
  { id: 12, name: 'Oceanic White-tip Shark', scientificName: 'Carcharhinus longimanus', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b', habitat: 'Marine', size: 'Large', status: 'protected',
  ...
  { id: 13, name: 'Porbeagle Shark', scientificName: 'Lamna nasus', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e', habitat: 'Marine', size: 'Large', status: 'protected',
  ...
  { id: 14, name: 'Sawfish', scientificName: 'Pristis spp.', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1531297484001-80022131f5a1', habitat: 'Marine', size: 'Large', status: 'protected',
  ...
  { id: 15, name: 'Seahorses', scientificName: 'Hippocampus spp.', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7', habitat: 'Marine', size: 'Small', status: 'protected',
  ...
  { id: 16, name: 'Silky Shark', scientificName: 'Carcharhinus falciformis', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1518770660439-4636190af475', habitat: 'Marine', size: 'Large', status: 'protected',
  ...
  { id: 17, name: 'White Teatfish', scientificName: 'Holothuria fuscogilva', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b', habitat: 'Marine', size: 'Medium', status: 'protected',
  ...
  { id: 18, name: 'Black Teatfish', scientificName: 'Holothuria nobilis', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e', habitat: 'Marine', size: 'Medium', status: 'protected',
  ...
  { id: 19, name: 'Thresher Sharks', scientificName: 'Alopias spp.', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1531297484001-80022131f5a1', habitat: 'Marine', size: 'Large', status: 'protected',
  ...
  { id: 20, name: 'Wedgefishes', scientificName: 'Rhinidae spp.', description: 'Protected species', imageUrl: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7', habitat: 'Marine', size: 'Large', status: 'protected',
  ...
  { id: 21, name: 'Orange-Spotted Grouper', scientificName: 'Epinephelus coioides', description: 'Popular food fish', imageUrl: 'https://images.unsplash.com/photo-1518770660439-4636190af475', habitat: 'Freshwater', size: '25-30 cm', status: 'non-protected',
  ...
  { id: 22, name: 'Leopard Coral Trout', scientificName: 'Plectropomus leopardus', description: 'Coral reef predator', imageUrl: 'https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b', habitat: 'Marine', size: 'Up to 120 cm', status: 'non-protected',
  ...
  { id: 23, name: 'Spotted Coral Trout', scientificName: 'Plectropomus maculatus', description: 'Spotted reef-dwelling fish', imageUrl: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e', habitat: 'Marine', size: '30 cm', status: 'non-protected',
  ...
  { id: 24, name: 'Malabar Grouper', scientificName: 'Epinephelus malabaricus', description: 'Large reef-associated fish', imageUrl: 'https://images.unsplash.com/photo-1531297484001-80022131f5a1', habitat: 'Marine', size: '58-64 cm', status: 'non-protected',
  ...
  { id: 25, name: 'Honeycomb Grouper', scientificName: 'Epinephelus quoyanus', description: 'Distinctive honeycomb pattern', imageUrl: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7', habitat: 'Marine', size: '24 cm', status: 'non-protected',
  ...
  { id: 26, name: 'Chocolate Hind', scientificName: 'Cephalopholis boenak', description: 'Small grouper with chocolate coloration', imageUrl: 'https://images.unsplash.com/photo-1518770660439-4636190af475', habitat: 'Marine', size: '12 cm', status: 'non-protected',
  ...
  { id: 27, name: 'Brown-Marbled Grouper', scientificName: 'Epinephelus fuscoguttatus', description: 'Large grouper with mottled pattern', imageUrl: 'https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b', habitat: 'Marine', size: '95 cm', status: 'non-protected',
  ...
  { id: 28, name: 'Giant Grouper', scientificName: 'Epinephelus lanceolatus', description: 'Largest bony fish in coral reefs', imageUrl: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e', habitat: 'Marine', size: 'Up to 270 cm', status: 'non-protected',
  ...
  { id: 29, name: 'Greasy Grouper', scientificName: 'Epinephelus tauvina', description: 'Common reef fish', imageUrl: 'https://images.unsplash.com/photo-1531297484001-80022131f5a1', habitat: 'Marine', size: '75 cm', status: 'non-protected',
  ...
  { id: 30, name: 'Barramundi / Seabass', scientificName: 'Lates calcarifer', description: 'Popular sport and food fish', imageUrl: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7', habitat: 'Freshwater/Marine', size: '29-60 cm', status: 'non-protected',
  ...
  { id: 31, name: 'Red Snapper', scientificName: 'Lutjanus campechanus', description: 'Highly valued food fish', imageUrl: 'https://images.unsplash.com/photo-1518770660439-4636190af475', habitat: 'Marine', size: '60-100 cm', status: 'non-protected',
  ...
  { id: 32, name: 'John Dory', scientificName: 'Zeus faber', description: 'Distinctive laterally compressed fish', imageUrl: 'https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b', habitat: 'Marine', size: '30-50 cm', status: 'non-protected',
  ...
  { id: 33, name: 'Sea Bream', scientificName: 'Pagrus major', description: 'Common food fish', imageUrl: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e', habitat: 'Marine', size: '40-60 cm', status: 'non-protected',
  ...
  { id: 34, name: 'Silver Pomfret', scientificName: 'Pampus argenteus', description: 'Highly valued table fish', imageUrl: 'https://images.unsplash.com/photo-1531297484001-80022131f5a1', habitat: 'Marine', size: '25-35 cm', status: 'non-protected',
  ...
  { id: 35, name: 'Threadfin Bream', scientificName: 'Nemipterus spp.', description: 'Common food fish', imageUrl: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7', habitat: 'Marine', size: '15-30 cm', status: 'non-protected',
  ...
  { id: 36, name: 'Blacktip Reef Shark', scientificName: 'Carcharinus melanopterus', description: 'Reef-associated shark', imageUrl: 'https://images.unsplash.com/photo-1518770660439-4636190af475', habitat: 'Marine', size: '96 cm', status: 'non-protected',
  ...
  { id: 37, name: 'Golden Pomfret', scientificName: 'Trachinotus blochii', description: 'Highly valued food fish', imageUrl: 'https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b', habitat: 'Marine', size: '30-60 cm', status: 'non-protected',
  ...
  { id: 38, name: 'Yellowfin Tuna', scientificName: 'Thunnus albacares', description: 'Important commercial fish', imageUrl: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e', habitat: 'Marine', size: '150-200 cm', status: 'non-protected',
  ...
  { id: 39, name: 'Milkfish', scientificName: 'Chanos chanos', description: 'Important food fish in Southeast Asia', imageUrl: 'https://images.unsplash.com/photo-1531297484001-80022131f5a1', habitat: 'Marine/Brackish', size: '70-100 cm', status: 'non-protected',
  ...
  { id: 40, name: 'Tilapia', scientificName: 'Oreochromis niloticus', description: 'Important farmed food fish', imageUrl: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7', habitat: 'Freshwater', size: '20-40 cm', status: 'non-protected',
